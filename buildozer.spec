...
# (str) Package name
package.name = restaurantmanagement

# (str) Package domain (needed for android/os packaging)
...
source.include_patterns = kivy_app/kv/*,kivy_app/screens/*,kivy_app/utils/*,kivy_app/widgets/*,assets/*
